...
### 共通設定
from main_speech5 import Config
config = Config()
common.config  = config
common.prefix  = "data%s_main_speech5" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_main_speech5" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python3 main_speech5.py " # 実行されるプログラム
common.columns =['dataset','seed','id','NN','Nh','alpha_i','alpha_r','alpha_b','alpha_s','beta_i','beta_r','beta_b','Temp','lambda0','cnt_overflow','WSR']
common.parallel= 100
common.setup()
...
def optimize():
    ...
    opt.minimize(target="WSR",iteration=30,population=30,samples=1)
