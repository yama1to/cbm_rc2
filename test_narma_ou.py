...
### 共通設定
from main_narma_ou import Config
config = Config()
common.config  = config
common.prefix  = "data%s_main_narma_ou" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_main_narma_ou" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python3 main_narma_ou.py " # 実行されるプログラム
