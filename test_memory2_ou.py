...
### 共通設定
from main_memory2_ou import Config
import warnings
...
common.prefix  = "data%s_memory2_ou" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_memory2_ou" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python3 main_memory2_ou.py " # 実行されるプログラム
