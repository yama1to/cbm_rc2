...
### 共通設定
from main_ipc4 import Config
config = Config()
common.config  = config
common.prefix  = "data%s_main_ipc4" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_main_ipc4" % common.string_now() # 実験データを出力するディレクトリのパス
